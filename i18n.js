...
en: {
  ...
  alltime_savings_hint:'Total income minus total spending since you started using the app, on {date}.',
...
ja: {
  ...
  alltime_savings_hint:'{date}にアプリを使い始めてからの総収入から総支出を引いた金額です。',
  view_breakdown:'内訳を見る',
...
ne: {
  ...
  alltime_savings_hint:'तपाईंले {date} बाट एप प्रयोग गर्न सुरु गरेदेखि हालसम्मको कुल आम्दानी घटाउ कुल खर्च।',
  view_breakdown:'विवरण हेर्नुहोस्',
...
hi: {
  ...
  alltime_savings_hint:'आपने {date} को ऐप इस्तेमाल शुरू किया था, तब से अब तक कुल आय घटा कुल खर्च।',
  view_breakdown:'विवरण देखें',
...
es: {
  ...
  alltime_savings_hint:'Ingreso total menos gasto total desde que empezaste a usar la app, en {date}.',
...
zh: {
  ...
  alltime_savings_hint:'自 {date} 您开始使用本应用以来的总收入减去总支出。',
  view_breakdown:'查看明细',
